...
<script type="text/javascript">
	function fn_imageUp() {
		var _formV = document.editor_upimage.Filedata;
		if(_formV.value == "" || _formV.value == null){
			alert("사진을 선택해주세요.");
		}else{
	...
	function fn_imageUp5() {
		var _formV = document.editor_upimage5.Filedata;
		if(_formV.value == "" || _formV.value == null){
			alert("사진을 선택해주세요.");
		}else{
...
<div id="pop_wrap">
	...
	<div id="pop_container2" class="pop_container2">    	
		...
		<div id="pop_footer">
		    <div class="btn_area">
	            <a href="javascript:fn_imageUp();">
	            <img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인"></a>
    ...
    <div id="pop_container" class="pop_container" style="display:none;">
		...
		<div id="pop_footer">
	    <div class="btn_area">
            <a href="javascript:fn_imageUp5();">
            <img src="../../img/photoQuickPopup/btn_confirm.png" width="49" height="28" alt="확인" id="btn_confirm"></a>
            <a href="#"><img src="../../img/photoQuickPopup/btn_cancel.png" width="48" height="28" alt="취소" id="btn_cancel"></a>
        </div>
    </div>
        <!-- //content -->
